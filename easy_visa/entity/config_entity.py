...
class ModelTrainerConfig:
    ...
    trained_model_file_path: str = os.path.join(model_trainer_dir, MODEL_TRAINER_TRAINING_MODEL_DIR, MODEL_TRAINER_TRAINING_MODEL_NAME)
