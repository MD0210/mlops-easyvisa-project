...
from easy_visa.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from easy_visa.entity.config_entity import ModelTrainerConfig
from easy_visa.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
from easy_visa.entity.estimator import EasyvisaModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            easyvisa_model = EasyvisaModel(preprocessing_object=preprocessing_obj,
                                       trained_model_object=best_model_detail.best_model)
            logging.info("Created easyvisa model object with preprocessor and model")
            logging.info("Created best model file path.")
            save_object(self.model_trainer_config.trained_model_file_path, easyvisa_model)
